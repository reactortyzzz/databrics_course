...
.withColumnRenamed('constructorRef', 'constructor_ref').withColumn("date_source", lit(v_data_source))
...
timestamp_df.write.mode("overwrite").parquet(f"{processed_folder_path}/constructors")
